...
def add_test_client():
    ...
    db.session.add_all(
        [new_investment_client, new_investment_joint, new_investment_partner])
    db.session.commit()
    ...
    db.session.add_all(
        [new_property_client, new_property_joint, new_property_partner])
    db.session.commit()
    ...
    db.session.add_all(
        [new_liability_client, new_liability_joint, new_liability_partner])
    db.session.commit()
    ...
    db.session.add_all([new_lifestyleasset_client,
                       new_lifestyleasset_joint, new_lifestyleasset_partner])
    db.session.commit()
